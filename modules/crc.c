...
{ //(X^16 + X^15 + X^2 + 1).
    ...
    uint16_t CRCHi = 0xFF, CRCLo = 0xFF;
    uint8_t* checkMess;
    ...
    {
        uIndex = CRCHi ^ *checkMess++; /* calculate the CRC */
        CRCHi = CRCLo ^ tableCRC16Hi[uIndex];
